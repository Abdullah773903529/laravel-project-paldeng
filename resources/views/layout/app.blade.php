    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="{{ route('posts.index')}}" class="navbar-brand d-flex align-items-center text-center">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        {{-- <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Edit</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="property-list.html" class="dropdown-item">Edit Section</a>
                                <a href="{{ route('buildings.edit',1) }}" class="dropdown-item">Edit building</a>
                                <a href="property-agent.html" class="dropdown-item">Edit Section</a>
                            </div>
                        </div> --}}
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Add</a>
                            <div class="dropdown-menu rounded-0 m-0">
                                <a href="{{ route('sections.create') }}" class="dropdown-item">Section</a>
                                <a href="{{ route('buildings.create') }}" class="nav-item nav-link">Add Customer</a>
                                <a href="{{ route('builds.creat') }}" class="dropdown-item">Build</a>
                                <a href="{{ route('manager.create') }}" class="dropdown-item">Manager</a>
                                <a href="{{ route('cumments.creat') }}" class="dropdown-item">Cumments</a>
                            </div>
                        </div>
